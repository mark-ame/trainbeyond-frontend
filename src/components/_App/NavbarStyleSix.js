                                    ...
                                    <ul className="dropdown-menu">
                                        <li className="nav-item">
                                            ...
                                            <ul className="dropdown-menu">
                                                ...
                                                <li className="nav-item">
                                                    <Link to="/features/information-retrieval" activeClassName="active" onClick={toggleNavbar} className="nav-link">
                                                        Features Details
                                                    </Link>
                                                </li>
                                            </ul>
                                        ...
                                        <li className="nav-item">
                                            ...
                                            <ul className="dropdown-menu">
                                                ...
                                                <li className="nav-item">
                                                    <Link to="/projects/ui-ux-design" activeClassName="active" onClick={toggleNavbar} className="nav-link">
                                                        Project Details
                                                    </Link>
                                                </li>
                                            </ul>
